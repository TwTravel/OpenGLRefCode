...
// Demonstrates rendering with display lists
...
GLuint nPartsList;
GLuint HEAD_LIST, SHAFT_LIST, THREAD_LIST;
...
void SetupRC()
    ...
    HEAD_LIST = nPartsList;
    SHAFT_LIST = nPartsList+1;
    THREAD_LIST = nPartsList+2;
...
int main(int argc, char* argv[])
    ...
    glutCreateWindow("Display List Bolt");
