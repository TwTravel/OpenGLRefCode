/********************************************************************
	...
	编写人：临风    E-Mail: ringphone@sina.com
			马翔	E-Mail: hugesoft@yeah.net
			YZ		E-Mail: yzfree@sina.com
...
enum PROCCOMM
{
	...
	PCM_ANIEFF = 4096,   // 图像动态效果处理
	PCM_FADEIN,          // 叠映
	PCM_ALPHASCROLL,     // ALPHA卷轴
	PCM_BURNUP,          // 火焰吞噬
	//PCM_XXXXX,         // 图像动态效果处理命令在此插入
	//$$$$$$$$$$$$$$$Added by leye 2001-03-17
	PCM_LINEUP,			 //随机直线填充
	//$$$$$$$$$$$$$$$Ended
	PCM_MAX				 // 边界值
};
