...
# ADD LINK32 iseeirw.lib vfw32.lib iseeio.lib ce.lib /nologo /subsystem:windows /machine:I386 /libpath:"..\lib"
...
# ADD LINK32 iseeirw.lib vfw32.lib iseeio.lib ce.lib /nologo /subsystem:windows /profile /debug /machine:I386 /out:"../bin/test.exe" /libpath:"..\lib"
