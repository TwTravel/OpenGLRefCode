...
IRWP_INFO			bw_irwp_info;			/* 插件信息表 */

#ifdef WIN32
CRITICAL_SECTION	bw_get_info_critical;	/* bw_get_image_info函数的关键段 */
CRITICAL_SECTION	bw_load_img_critical;	/* bw_load_image函数的关键段 */
CRITICAL_SECTION	bw_save_img_critical;	/* bw_save_image函数的关键段 */
#else
/* Linux对应的语句 */
#endif
