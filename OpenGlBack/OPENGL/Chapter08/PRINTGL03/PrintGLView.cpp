...
BEGIN_MESSAGE_MAP(CPrintGLView, CView)
	...
	ON_UPDATE_COMMAND_UI(ID_FILE_CAPTURE, OnUpdateFileCapture)
...
bool CPrintGLView::BeginMovieCapture(CString filename,
                              int width, int height,
                              float framerate)
{
    movieCapture = new CAVICapture();
...
void CPrintGLView::initMovieCapture(CAVICapture* mc)
{
    if (movieCapture == NULL)
        movieCapture = mc;
}

void CPrintGLView::recordBegin()
{
    if (movieCapture != NULL)
        recording = true;
}

void CPrintGLView::recordPause()
{
	    recording = false;
}

void CPrintGLView::recordEnd()
{
    if (movieCapture != NULL)
    {
        recordPause();
...
bool CPrintGLView::isRecording()
{
    return recording;
}


void CPrintGLView::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void CPrintGLView::OnFileCapture() 
{
...
void CPrintGLView::OnUpdateFileCapture(CCmdUI* pCmdUI) 
{
